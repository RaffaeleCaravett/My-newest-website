        ...
        <div className="container py-5">
            <div className="row py-5">
                <div className="col-md-12 py-5">
                    ...
                    <p>Completa il form qui sotto per mandarmi una mail. <span className="text-danger"><u> Risponderò il prima possibile. </u> </span></p>
                </div>
                <div className="col-md-12">
                    <form className="w-75 m-auto" onSubmit={(e) => contact(e)}>
                        ...
                        <button className="shadow btn btn-warning my-5 bnt-light" title="Sottometti il form e mandami una mail!" type="submit">Invia</button>
                    </form>
                </div>
            </div>
            <ToastContainer />
